...
# --------------------------------------------------------------
BOT_TOKEN = getenv("BOT_TOKEN", "8048266755:AAHQ6HNkXL_Vmt-LF46R2n_ARBeLkynVlYA"None)
...
MONGO_URL = getenv("MONGO_URL", "mongodb+srv://knight4563:knight4563@cluster0.a5br0se.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"None)
OWNER_ID = int(getenv("OWNER_ID", "7926944005"))
SUPPORT_GRP = "dark_x_knight_musiczz_support"
UPDATE_CHNL = "dark_x_knight_musiczz_support"
OWNER_USERNAME = "ll_KUZE_ll"
